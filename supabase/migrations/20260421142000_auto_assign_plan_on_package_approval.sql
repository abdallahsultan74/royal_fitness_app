-- When staff assigns a user package, auto-assign one of the package's bound training plans.
-- This makes the user see the plan immediately after approval (no manual assign needed).
